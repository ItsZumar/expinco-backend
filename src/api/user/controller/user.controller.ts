...
export const emailSignup = catchAsync(
...
export const emailSignin = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    await check("email", "Email is not valid").isEmail().run(req);
...
export const changePassword = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    await check("oldPassword", "Please enter your old password.")
      .isString()
      .run(req);
    await check("newPassword", "Please enter a new password")
      .isString()
      .run(req);
...
export const updateProfile = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    await check("firstname", "Firstname is not valid")
      .isString()
      .optional()
      .run(req);
    await check("lastname", "Lastname is not valid")
      .isString()
      .optional()
      .run(req);
